import { version as version$1, createVNode, mergeProps, Transition, toRefs, shallowRef, ref, computed, watch, nextTick, toRef, watchEffect, provide, onScopeDispose, withDirectives, resolveDirective, vShow, Fragment, reactive, inject as inject$1, capitalize, h, onUpdated, hasInjectionContext, getCurrentInstance as getCurrentInstance$1, defineComponent as defineComponent$1, camelize, unref, toRaw, readonly, TransitionGroup, isRef, Text, resolveDynamicComponent, effectScope, warn, Teleport, cloneVNode, createTextVNode, vModelText, useSSRContext, createApp, onErrorCaptured, onServerPrefetch, isReadonly, defineAsyncComponent, isShallow, isReactive, withCtx, Suspense } from 'vue';
...
async function applyPlugins(nuxtApp, plugins2) {
  ...
  for (const plugin2 of plugins2) {
    ...
    if ((_a2 = plugin2.meta) == null ? void 0 : _a2.parallel) {
...
function defineNuxtPlugin(plugin2, meta) {
  ...
  wrapper.meta = {
    name: (meta == null ? void 0 : meta.name) || plugin2.name || ((_a2 = plugin2.setup) == null ? void 0 : _a2.name),
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-da18e9b1.mjs').then((m) => m.default || m)
  }
];
...
const _sfc_main = {
  ...
  setup(__props) {
    const ErrorComponent = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-component-297ee9f1.mjs').then((r) => r.default || r));
